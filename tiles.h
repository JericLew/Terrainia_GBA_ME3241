...
#define LEN_TILEPAL 256

const u16 tiles_palette[ LEN_TILEPAL ] = {
...
// each pixel is 16 bits aka 0xXX
// tile len = 4*8*no.of tiles
#define LEN_TILEDATA 4*8*10

const u16 tiles_data[ LEN_TILEDATA ] = {
#define CBG 0
