...
_Bool canPlayerMove(void)
{
    _Bool bot_left,bot_right;
    bot_left = lvl1_map[(PLAYERONE_x+map_dx/256)/8 + (PLAYERONE_y + 16 + map_dy/256)/8*64] == 0x00;
    bot_right = lvl1_map[(PLAYERONE_x + 16 + map_dx/256)/8 + (PLAYERONE_y + 16 + map_dy/256)/8*64] == 0x00;
