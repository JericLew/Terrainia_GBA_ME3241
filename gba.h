...
//direct to BGPal, each index is 16bits, 1 colour
#define BGPal                      ((unsigned short *) 0x5000000)
//direct to CBB 0 to store tile data, each index is 16bits, 2 pixels
#define tileMem                    ((unsigned short *) 0x6000000) 
//direct to SBB 8 to load into map, each index is 8bits, which is tile index
#define se_mem                     ((unsigned short *) 0x6004000) 
